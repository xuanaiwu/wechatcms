	...
	var _this = {
		...
		addDefBtns:function(){
			var defaultBtns= [
				...
				{"btnName":"只读","menuid":2,"actionUrls":"dataList.do","btnType":"read"}   //xuanaiwu 20160712
			];
		...
		addLine: function(data){
			...
			$(".remove-btn",line).click(function(){
				dy.confirm('Confirm','Are you sure you want to delete record?',function(r){
					if(r){
						_this.delLine(line);
					}
				})
  			...
  			dataGrid:{
  				title:'菜单信息',
	   			...
	   			columns:[[
					...
					{field:'rank',title:'层级',align:'right',width:80,sortable:true},
					{field:'url',title:'菜单链接',width:220,sortable:true},
					...
					{field:'childMenus',title:'子菜单',width:120,align:'center',formatter:function(value,row,index){
						var html ="<a href='#' onclick='dy.sysMenu.toList("+row.id+")'>子菜单管理("+row.subCount+")</a>";
						return html;
					}}
				]],
				toolbar:[
